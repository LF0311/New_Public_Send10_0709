...
def read_files_split(df):
    ...
    for tme in range(len(df[0])):
        if str('\x00') not in df[13][tme] and str('NGGA') not in df[13][tme] and str(',') not in df[13][tme] \
            ...
            result_time = target_time + datetime.timedelta(seconds=float(df[13][tme].split(':')[0]))
            # 将结果转换为UTC时间格式
            result_time_utc = result_time.strftime('%Y-%m-%d %H:%M:%S')
            # # 使用.loc进行赋值操作
            # df.loc[tme, 'T'] = result_time_utc
            time_list.append(result_time_utc)
            n_list.append(df[13][tme].split(':')[2])
            e_list.append(df[13][tme].split(':')[1])
            id_sent_list.append(id_sent_dic[str(df[1][tme])])
            # print(df)
        else:
            time_list.append(
                str((datetime.datetime.now() + datetime.timedelta(hours=8) - datetime.timedelta(seconds=(len(df[0]) - tme))).strftime("%Y-%m-%d %H:%M:%S")))
            n_list.append('None')
            e_list.append('None')
            id_sent_list.append(id_sent_dic[str(df[1][tme])])
...
def app1():
    ...
    # 服务器IP地址和端口号
    UDP_IP = "10.10.21.96"  # 测试网关IP：51.51.51.96   服务器IP：10.10.21.96  车辆IP：
    UDP_IP_2 = "10.10.21.97"  # 51.51.51.50
    UDP_IP_3 = "10.10.21.98"  # 51.51.51.50
    UDP_PORT = 1438
    ...
    if not button4 and not button3:
        if button2:
            ...
            sock.sendto(command_real_time, (UDP_IP_2, UDP_PORT))
            sock.sendto(command_real_time, (UDP_IP_3, UDP_PORT))
            # sock.sendto(command_real_time, (UDP_IP, UDP_PORT))
            ...
            # received_data = b"\xbb\xbb<\x82\x9e\x10\xc4\x10\xee\x10\xf4\x10-\x11\x00\x00\x92\x08\xf4\x02V\xc0*\n\x00\x0005844.000:3951.00097:11617.16356\xf39\xbb\xbb<\x82\xd0\x10\xdc\x10\xd0\x10\xe2\x10R\x11\x00\x00\xb0\x08\xd9\x025\xc0*\n\x00\x0005845.000:3951.00100:11617.16359\xd3\xab\xbb\xbb<\x82\xd0\x10\xd6\x10\xd0\x10\x05\x11\x11\x11\x00\x00}\x08\xe4\x02`\xc0\xce\t\x00\x0005847.000:3951.00103:11617.16361\\Z\xbb\xbb<\x82\xfa\x10\x11\x11\x05\x11a\x10\xab\x10\x00\x00\x91\x08\xd0\x02\x90\xc0\x9c\t\x00\x0005848.000:3951.00100:11617.16364\xe8\x18\xbb\xbb<\x82\xd6\x102\x11\xb6\x112\x11\xca\x10\x00\x00\x9c\x08\xdf\x02\x84\xc0\xfd\t\x00\x0005850.000:3951.00092:11617.16370\xea\xde\xbb\xbb<\x82'\x11-\x11'\x11\xb1\x10\xbe\x10\x00\x00\xbe\x08\xb4\x02<\xc0\xce\t\x00\x0005921.000:3950.99989:11617.16441\xf4>\xbb\xbb<\x82\xe8\x10\x11\x11b\x11\x00\x11\xab\x10\x00\x00\xa1\x08\xe0\x02\x94\xc0\xfd\t\x00\x0005922.000:3950.99989:11617.16442,3\xbb\xbb<\x82\xca\x10\xd0\x10-\x11\xe2\x10\xe8\x10\x00
c3\x02\xc8\xbf\xce\t\x00\x0010113.000:3950.99973:11617.16439ZQ\xbb\xbb<\x82-\x118\x11\x11\x11=\x11\xa4\x10\x00\x00\x80\x08\xb5\x02\xcb\xbfh\t\x00\x0010114.000:3950.99975:11617.16439\xbb\xaa\xbb\xbb<\x822\x11\x83\x10\x83\x10-\x11\x00\x11\x00\x00\x88\x08\xcb\x02\x9b\xbf\xa3\n\x00\x0010116.000:3950.99979:11617.16440?*\xbb\xbb<\x82\x97\x10\x00\x11\x91\x10\x8b\x11C\x11\x00\x00t\x08\xe8\x02\xd6\xbf\x9c\t\x00\x0010147.000:3951.00023:11617.16453\xc7!\xbb\xbb<\x82'\x11\xa4\x10\x0b\x11H\x11\xbe\x10\x00\x00t\x08\xb1\x02\xda\xbf\xeb\n\x00\x0010149.000:3951.00024:11617.16454\x92\xfa\xbb\xbb<\x82\x00\x11\x11\x11\x94\x11-\x11\xd0\x10\x00\x00\x80\x08\xe0\x02\xc9\xbf\xfd\t\x00\x0010150.000:3951.00025:11617.164548\x89\xbb\xbb<\x82\xb7\x10\x11\x11\x94\x11\x17\x112\x11\x00\x00a\x08\xb8\x02\xc9\xbf\xeb\n\x00\x0010151.000:3951.00026:11617.16454\x0f\xd3\xbb\xbb<\x82>\x10g\x11\x17\x11\x0b\x11w\x11\x00\x00|\x08\xe6\x02\x1e\xc0\r\x0b\x00\x0010153.000:3951.00028:11617.16455{\xc7\xbb\xbb<\x82E\x102\x11\xb1\x10|\x11l\x11\x00\x00\x84\x08\xdb\x02\xda\xbf\xeb\n\x00\x0010224.000:3951.00059:11617.16438\x84\xd3\xbb\xbb<\x82\x97\x10\xd6\x10X\x11M\x11\xfa\x10\x00\x00T\x08\xe8\x02\xf8\xbf*\n\x00\x0010227.000:3951.00061:11617.164352\x13"
    ...
    try:
        # 添加地图信息
        if 'sensor_node' in st.session_state.parameters:
            if 'E' in st.session_state.parameters['sensor_dfs'][st.session_state.parameters['sensor_node']] and \
                    'N' in st.session_state.parameters['sensor_dfs'][st.session_state.parameters['sensor_node']]:
                if st.session_state.parameters['sensor_dfs'][st.session_state.parameters['sensor_node']]['E'].iloc[0] == str(None) \
                        or st.session_state.parameters['sensor_dfs'][st.session_state.parameters['sensor_node']]['N'].iloc[0] == str(None):
                    locations = []
                    customers = []  # ['北京', '上海', '武汉', '长沙', '成都', '广州']
                else:
                    tmp_e = st.session_state.parameters['sensor_dfs'][st.session_state.parameters['sensor_node']]['E'].iloc[0]
                    tmp_n = st.session_state.parameters['sensor_dfs'][st.session_state.parameters['sensor_node']]['N'].iloc[0]
                    gcl_lng, hcl_lat = wgs84_to_gcj02(float(tmp_n[0:3]) + float(tmp_n[3:]) / 60,
                                                      float(tmp_e[0:2]) + float(tmp_e[2:]) / 60)  # 经纬度

                    locations = [[hcl_lat, gcl_lng], ]  # 纬经度
                    customers = [st.session_state.parameters['sensor_node'], ]  # ['北京', '上海', '武汉', '长沙', '成都', '广州']
            else:
                locations = []
                customers = []  # ['北京', '上海', '武汉', '长沙', '成都', '广州']
        else:
            # 添加地图信息
            if 'E' in st.session_state.parameters['final_read_file_df'] and \
                    'N' in st.session_state.parameters['final_read_file_df']:
                if st.session_state.parameters['final_read_file_df']['E'].iloc[0] == str(None) or \
                        st.session_state.parameters['final_read_file_df']['N'].iloc[0] == str(None):
                    locations = []
                    customers = []  # ['北京', '上海', '武汉', '长沙', '成都', '广州']
                else:
                    gcl_lng, hcl_lat = wgs84_to_gcj02(
                        float(st.session_state.parameters['final_read_file_df']['N'].iloc[0][0:3]) +
                        float(st.session_state.parameters['final_read_file_df']['N'].iloc[0][3:]) / 60,
                        float(st.session_state.parameters['final_read_file_df']['E'].iloc[0][0:2]) +
                        float(st.session_state.parameters['final_read_file_df']['E'].iloc[0][2:]) / 60
                    )  # 经纬度

                    locations = [[hcl_lat, gcl_lng], ]  # 纬经度
                    customers = [st.session_state.parameters['final_read_file_df']['Id'].iloc[0]]  # ['北京', '上海', '武汉', '长沙', '成都', '广州']
            else:
                locations = []
                customers = []  # ['北京', '上海', '武汉', '长沙', '成都', '广州']
    except KeyError:
        print('seesion_state中不包含数据final_read_file_df')
        locations = []
        customers = []  # ['北京', '上海', '武汉', '长沙', '成都', '广州']
    ...
    if sensor_node_select is not None:
        ...
        st.session_state.parameters['sensor_node'] = sensor_node
    ...
    if button4:  # 开始识别按钮
        if len(st.session_state.parameters['final_read_file_df']) != 0 \
            ...
            if 55 not in st.session_state.parameters['unique_ids']:
                # 通过传感器信号阈值识别目标
                target_mblb_tmp = {}
                print(st.session_state.parameters['unique_ids'])

                for tmp_id in st.session_state.parameters['unique_ids']:  # 检测所有传感器
                    z_gyro_data = st.session_state.parameters['sensor_dfs'][tmp_id]['Z_Gyro']
                    print(tmp_id)
                    print(z_gyro_data)

                    # 计算大于14的数据个数
                    count_gt_14 = (z_gyro_data > 15).sum()
                    print(count_gt_14)
                    count_gt_30 = (z_gyro_data > 30).sum()
                    print(count_gt_30)
                    count_gt_40 = (z_gyro_data > 40).sum()
                    print(count_gt_40)

                    if count_gt_14 >= 3 and count_gt_30 >= 2 and count_gt_40 >= 1:  # 任意三个值大于14，任意两个值大于30，任意一个值大于40；；
                        target_mblb_tmp.update({tmp_id: '车辆'})
                        print("target_mblb_tmp.update({tmp_id: '车辆'})")
                    elif (z_gyro_data > 0).any():
                        target_mblb_tmp.update({tmp_id: '人员'})
                        print("target_mblb_tmp.update({tmp_id: '人员'})")
                    else:
                        target_mblb_tmp.update({tmp_id: '无'})

                    # if (st.session_state.parameters['sensor_dfs'][tmp_id]['Z_Gyro'] > 14).any():
                    ...
                    #         }
                    #     )
                print(target_mblb_tmp)
                # 判断是否全为 '无'

                if all(value == '无' for value in target_mblb_tmp.values()):
                    print("未识别到目标")
                    st.session_state.parameters['target_mblb'] = '无'
                    ...
                    print(st.session_state.parameters['sensor_node'])
                    # 获取当前节点对应的目标类型
                    selected_label = target_mblb_tmp.get(st.session_state.parameters['sensor_node'])

                    if selected_label == '人员':
                        target_mblb = '人员'
                        st.session_state.parameters['target_mblb'] = target_mblb
                        id_list = [str(key) for key, value in target_mblb_tmp.items() if value == '人员']
                        col_sub_2.image("pic1.png", width=120)
                    elif selected_label == '车辆':
                        target_mblb = '车辆'
                        st.session_state.parameters['target_mblb'] = target_mblb
                        id_list = [str(key) for key, value in target_mblb_tmp.items() if value == '车辆']
                        col_sub_2.image("pic3.png", width=120)
                ...
                #         st.session_state.parameters['target_mblb'] = target_mblb
                #         id_list = [str(key) for key, value in target_mblb_tmp.items() if value == '车辆']
                #         col_sub_2.image("pic3.png", width=120) # pic3 车辆
            ...
            trace1_1 = go.Scatter(
                ...
                y=st.session_state.parameters['sensor_dfs'][sensor_node]['Z_Mag'],  # 'X_Accel', 'Z_Mag', 'X_Gyro', 'Y_Gyro'
                mode='lines',
                marker=dict(
                    color='black',
                    size=10,
            ...
            trace1_2 = go.Scatter(
                x=st.session_state.parameters['sensor_dfs'][sensor_node]['T'],
                y=st.session_state.parameters['sensor_dfs'][sensor_node]['X_Gyro'],  # 'X_Accel', 'Z_Mag', 'X_Gyro', 'Y_Gyro'
                mode='lines',
                marker=dict(
                    color='blue',
                    size=10,
            ...
            trace1_3 = go.Scatter(
                x=st.session_state.parameters['sensor_dfs'][sensor_node]['T'],
                y=st.session_state.parameters['sensor_dfs'][sensor_node]['Y_Gyro'],  # 'X_Accel', 'Z_Mag', 'X_Gyro', 'Y_Gyro'
                mode='lines',
                marker=dict(
                    color='red',
                    size=10,
            ...
            trace2 = go.Scatter(
                x=st.session_state.parameters['sensor_dfs'][sensor_node]['T'],
                y=st.session_state.parameters['sensor_dfs'][sensor_node]['Z_Gyro'],
                mode='lines',
                marker=dict(
                    color='black',
                    size=10,
        ...
        if 'target_mblb' in st.session_state.parameters and st.session_state.parameters['target_mblb'] == '人员':
            ...
            col_sub_1.plotly_chart(fig2, use_container_width=True)
            col_sub_1.plotly_chart(fig3, use_container_width=True)
        elif 'target_mblb' in st.session_state.parameters and st.session_state.parameters['target_mblb'] == '无':
            warning_container.empty()
            warning_container.image("pic2-2.png", width=150)
            # 创建X,Y,Z轴加速度散点图
            trace1_1 = go.Scatter(
    ...
    if button5: # 报警按钮
        ...
        if len(st.session_state.parameters['final_read_file_df']) != 0 \
            ...
            trace1_2 = go.Scatter(
                x=st.session_state.parameters['sensor_dfs'][sensor_node]['T'],
                y=st.session_state.parameters['sensor_dfs'][sensor_node]['X_Gyro'],
                mode='lines',
                marker=dict(
                    color='blue',
                    size=10,
            ...
            trace1_3 = go.Scatter(
                x=st.session_state.parameters['sensor_dfs'][sensor_node]['T'],
                y=st.session_state.parameters['sensor_dfs'][sensor_node]['Y_Gyro'],
                mode='lines',
                marker=dict(
                    color='red',
                    size=10,
